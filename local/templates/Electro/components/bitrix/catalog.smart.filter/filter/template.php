...
?>
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="aside bx-filter <?=$templateData["TEMPLATE_CLASS"]?> smartfilter">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					if (
						...
						continue;
					?>
                            <h3 class="aside-title"><?=$arItem["NAME"]?></h3>
							<?

...
<div class="products-widget-slick" data-nav="#slick-nav-top-selling-<?=$arParams['NAV_ID']?>">
	<?
	if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
	{
		...
		<!-- items-container -->
		<?
        $groupedArray = array_chunk($arResult["ITEMS"], 3);
		foreach ($groupedArray as $groupeItem)
		{
            ?>

						<div>
								<?
								foreach ($groupeItem as $item)
								{
